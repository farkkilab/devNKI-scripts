...
if(length(args)==2) {
  ...
  rmarkdown::render('D:/users/fperez/NKI_TMAs_AF/devNKI-scripts/3_Cell-typeClassification/R/report_pdf/report.Rmd',params = list(oldpath = args[1], newpath = "", comparison=FALSE))
} else {
