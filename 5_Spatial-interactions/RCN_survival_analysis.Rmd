...
Molecular.profiles.new <- clindata.shrd.patient %>% select(patient, Molecular.profile2)
write.table(Molecular.profiles.new,
            file="D:/users/fperez/NKI_TMAs_AF/Tables/Molecular_profiles_patients_2023.csv",
            sep=",", row.names=FALSE)
```
...
ggplot(RCN.proportions.patient.clin[RCN.proportions.patient.clin$rcn_id %in% rcn_set1,],
       aes(x=Molecular.profile2,y=Proportion, colour=Molecular.profile2)) +
...
p.vals.RCN4vsRCN6<- sapply(unique(RCN.proportions.patient.clin$Molecular.profile2), function(x){
  mol.dat <- RCN.proportions.patient.clin[RCN.proportions.patient.clin$Molecular.profile2 %in% x,]
...
p.vals.dataframe <- data.frame(pval=p.vals.RCN4vdRCN,
                     Molecular.profile=unique(RCN.proportions.patient.clin$Molecular.profile2),
                     y.val=28,
                     rcn_id="RCN04c")

rcn_set1 <- c("RCN04c","RCN06c")
p <- ggplot(RCN.proportions.patient.clin[RCN.proportions.patient.clin$rcn_id %in% rcn_set1,],
       aes(x=Molecular.profile2,y=Proportion, fill=rcn_id)) +
  geom_boxplot(outlier.shape = NA) + theme_bw() + xlab("Molecular profile") +
  theme(legend.title = element_blank(), axis.text.x=element_text(size=rel(1.2)),
...
p.vals.RCN6vsBRCA<- sapply(unique(RCN.proportions.patient.clin$Molecular.profile2), function(x){
  mol.dat <- RCN.proportions.patient.clin[RCN.proportions.patient.clin$rcn_id %in% rcn_set1,]
...
p.vals.dataframe <- data.frame(pval=p.vals.RCN6vsBRCA,
                     Molecular.profile=unique(RCN.proportions.patient.clin$Molecular.profile2),
                     y.val=18,
                     Molecular.profile2=unique(RCN.proportions.patient.clin$Molecular.profile2),
                     rcn_id=rcn_set1)

ggplot(RCN.proportions.patient.clin[RCN.proportions.patient.clin$rcn_id %in% rcn_set1,],
       aes(x=Molecular.profile2,y=Proportion, fill=Molecular.profile2)) +
  geom_boxplot(outlier.shape = NA) + theme_bw() + xlab("Molecular profile") +
  theme(axis.text.x=element_text(size=rel(1.2)), axis.title.x = element_text(size=rel(1.2))) + ylim(0,30) +
  geom_text(data = p.vals.dataframe[p.vals.dataframe$pval < 0.05,], aes(x=Molecular.profile, y=y.val),
            label="*", size=8) +
  annotate("text", x=2, y=30, label="P-values calculated againts BRCAmut", fontface="italic") +
  ggtitle(rcn_set1)
...
ggplot(RCN.proportions.patient.clin[RCN.proportions.patient.clin$rcn_id %in% rcn_set1,],
  ...
  theme(axis.text.x=element_text(size=rel(1.2)), axis.title.x = element_text(size=rel(1.2))) + ylim(0,10) +
  geom_text(data = p.vals.dataframe[p.vals.dataframe$pval < 0.05,], aes(x=Molecular.profile, y=y.val),
            label="*", size=8) +
  annotate("text", x=2, y=10, label="P-values calculated againts BRCAmut", fontface="italic") +
  ggtitle(rcn_set1)
...
ggplot(RCN.proportions.patient.clin[RCN.proportions.patient.clin$rcn_id %in% rcn_set1,],
       aes(x=Molecular.profile2,y=Proportion, fill=Molecular.profile2)) +
  geom_boxplot() + theme_bw() + xlab("Molecular profile") +
  theme(axis.text.x=element_text(size=rel(1.2)), axis.title.x = element_text(size=rel(1.2))) + ylim(0,8) +
  geom_text(data = p.vals.dataframe[p.vals.dataframe$pval < 0.05,], aes(x=Molecular.profile, y=y.val),
            label="*", size=8) +
  annotate("text", x=2, y=10, label="P-values calculated againts BRCAmut", fontface="italic") +
  ggtitle(rcn_set1)
...
ggplot(RCN.proportions.patient.clin[RCN.proportions.patient.clin$rcn_id %in% rcn_set1,],
       aes(x=Molecular.profile2,y=Proportion, fill=Molecular.profile2)) +
  geom_boxplot() + theme_bw() + xlab("Molecular profile") +
  theme(axis.text.x=element_text(size=rel(1.2)), axis.title.x = element_text(size=rel(1.2))) + ylim(0,3) +
  geom_text(data = p.vals.dataframe[p.vals.dataframe$pval < 0.05,], aes(x=Molecular.profile, y=y.val),
            label="*", size=8) +
  annotate("text", x=2, y=10, label="P-values calculated againts BRCAmut", fontface="italic") +
  ggtitle(rcn_set1)
