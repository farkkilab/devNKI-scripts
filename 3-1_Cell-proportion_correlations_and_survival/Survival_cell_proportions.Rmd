...
med.prop.profile <- med.prop.profile %>% filter(Molecular.profile2 != "Other")
...
mt.prop.scaled <- mt.prop.scaled %>% #select(CD4.T.cells, CD8.T.cells, T.regs, B.cells, CD11c.MY,
                                  ...
                                  select(CD4.T.cells, CD4.CD45RO.T.cells, CD4.PD1.T.cells, CD8.effector.T.cells,
                                         ...
                                         CD11c.MY, CD163.MP, CD68.MP, Other.MY)    %>%
                  as.matrix()
...
svg(paste0(output.folder, "Heatmap_Mprofile_Immune_prop.svg"), width=8, height=5)
draw(hmap)
dev.off()
```
...
cell.types.interest  <- list(c("CD163.MP","CD68.MP"))
...
p.vals.dataframe <- p.vals.markers2(dat, Profile.test="CCNE1amp", y.val=0.35, yvar="Proportion")
