...
cancers.pds <- cancers.clin %>% filter(!grepl("NACT",therapy_sequence),
                                       !is.na(therapy_sequence),
                                       Molecular.profile2 == "BRCAmut/met")
...
print(p)
ggsave(p, filename = paste0(out.folder.name,"/MHCII_expression_RNCs_BRCAmut_PDS.svg"),
