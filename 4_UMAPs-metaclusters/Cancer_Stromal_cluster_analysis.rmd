...
interesting.channels.stromal <- c("pTBK1","Ki67","Vimentin", "pSTAT1", "MHCI",
                      "ECadherin","aSMA","PDL1_488","Area","Eccentricity","Roundness")
...
tmpdir.cancer <- "D:/users/fperez/NKI_TMAs_AF/Analysis_results/02_MetaClusters_November/SOM_consensusClusters_cancer/"
tmpdir.stromal <- "D:/users/fperez/NKI_TMAs_AF/Analysis_results/02_MetaClusters_November/SOM_consensusClusters_stromal/"
...
```{r}
#Writing results
write.table(file="D:/users/fperez/NKI_TMAs_AF/Tables/All_cells_subtype-info_20231028.csv", big.data.set.subtypes, sep=",",
            row.names=FALSE)
```
...
write.table(file="D:/users/fperez/NKI_TMAs_AF/Tables/All_cells_scimap-format_columns-reduced_20231028.csv", aux1, sep=",",
            row.names=FALSE)
...
write.table(file="D:/users/fperez/NKI_TMAs_AF/Tables/All_cells_subtype_scimap-format1_20231028.csv", aux1, sep=",",
            row.names=FALSE)
...
write.table(file="D:/users/fperez/NKI_TMAs_AF/Tables/All_cells_subtype_scimap-format2_20231028.csv", aux2, sep=",",
            row.names=FALSE)
...
write.table(file=paste0(outout.folder.name, "Metaclusters_abundance_per_core_20231028.csv"), big.data.set.subtypes.numbers,
            sep=",", row.names=FALSE)
```
