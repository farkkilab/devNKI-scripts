...
def run_ml_experiments(data):
    ...
    return perform_ml_run(
        exp_name,
        channels,
        channels_to_transform,
        channels_to_outliers,
        channels_to_scale,
        types_of_cells,
        classes_column,
        classes_types,
...
if __name__ == '__main__':
    ...
    names = ['Lymphocytes-stromal_BRCAmutmet_VS_CCNE1amp_IDS_1.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_CCNE1amp_IDS_2.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_CCNE1amp_PDS_1.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_CCNE1amp_PDS_2.csv',
            
            'Lymphocytes-stromal_BRCAmutmet_VS_HRD_IDS_1.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_HRD_IDS_2.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_HRD_PDS_1.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_HRD_PDS_2.csv',
            
            'Lymphocytes-stromal_BRCAmutmet_VS_HRP_IDS_1.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_HRP_IDS_2.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_HRP_PDS_1.csv',
            'Lymphocytes-stromal_BRCAmutmet_VS_HRP_PDS_2.csv',
            
            'Lymphocytes-stromal_CCNE1amp_VS_HRD_IDS_1.csv',
            'Lymphocytes-stromal_CCNE1amp_VS_HRD_IDS_2.csv',
            'Lymphocytes-stromal_CCNE1amp_VS_HRD_PDS_1.csv',
            'Lymphocytes-stromal_CCNE1amp_VS_HRD_PDS_2.csv',
            
            'Lymphocytes-stromal_HRP_VS_CCNE1amp_IDS_1.csv',
            'Lymphocytes-stromal_HRP_VS_CCNE1amp_IDS_2.csv',
            'Lymphocytes-stromal_HRP_VS_CCNE1amp_PDS_1.csv',
            'Lymphocytes-stromal_HRP_VS_CCNE1amp_PDS_2.csv',
            
            'Lymphocytes-stromal_HRP_VS_HRD_IDS_1.csv',
            'Lymphocytes-stromal_HRP_VS_HRD_IDS_2.csv',
            'Lymphocytes-stromal_HRP_VS_HRD_PDS_1.csv',
            'Lymphocytes-stromal_HRP_VS_HRD_PDS_2.csv']
