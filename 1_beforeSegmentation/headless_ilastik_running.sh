...
ilastikfile="/mnt/d/users/fperez/NKI_TMAs_AF/Ilastik_labeling/Cellring_nuclei_background_Selected-Channels.ilp"
...
probfolder="Probmaps_cyto_nuc_backg"
...
for samplename in `ls -d ${projectfolder}/TMA* | xargs -I {} basename {} | tail -n 7`
do
