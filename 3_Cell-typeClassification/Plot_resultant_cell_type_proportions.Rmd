...
tribus.subfolder = "Tribus_Cell-segment_202303/"
...
merged.dat$GlobalCellType[grep("Stromal", merged.dat$GlobalCellType)] <- "Stromal"
#merged.dat$GlobalCellType[grep("CD8", merged.dat$GlobalCellType)] <- "CD8.T.cells"
#merged.dat$GlobalCellType[grep("CD4", merged.dat$GlobalCellType)] <- "CD4.T.cells"
```
...
aux.dat <- merged.dat
aux.dat[aux.dat$GlobalCellType != "Cancer" & aux.dat$GlobalCellType != "Stromal" & aux.dat$GlobalCellType != "Others","GlobalCellType"] <- "Immune"
...
merged.types.patients$GlobalCellType <- factor(merged.types.patients$GlobalCellType, levels=c("Cancer","Immune","Stromal","Others"))
...
p <- ggplot(merged.types.patients, aes(x=Patient, y=Proportion, fill=Cell.type)) +
        ...
        scale_fill_manual(values = c("#FF0E16", "#127D19", "#2CD8D8","grey")) +
        theme(axis.text.x=element_text(size=rel(0.2), angle = 65, hjust = 1))
print(p)
...
my.cell.levels <- c("CD11c.MY","CD15.MY","CD163.MP","CD207.MY",
                    "Other.MY", "CD4.T.cells", "CD4.CD45RO.T.cells", "CD8.CD45RO.T.cells",
                    "CD8.effector.T.cells", "CD8.exhausted.T.cells", "T.regs", "B.cells",
                    "Other.immune")
...
my.cell.levels <- c("CD8.T.cells", "CD4.T.cells", "T.regs", "CD11c.MY",
                    "CD163.MP","CD207.MY", "CD15.MY", "Other.MY", "B.cells", "Other.immune")
...
vars.all = c("CD8.CD45RO.T.cells","CD8.exhausted.T.cells","CD8.effector.T.cells",
             "Bcells","CD4.T.cells","CD4.CD45RO.T.cells",
