...
#Reading clinical info
clinical.info <- read.table(file="/home/fernpere/NKI/Clinical_data/T-CycIF.update.csv", sep=",", header = TRUE)

#Mol.profiles.patients <- read.table(file="/home/fernpere/NKI/Tables/Molecular_profiles_patients_2023.csv",
#            sep=",", header=TRUE)

Mol.profiles.patients <- read.table(file="/home/fernpere/NKI/Tables/Molecular_profiles_patients_20231123.csv",
            sep=",", header=TRUE)
...
cell.types.interest  <- list(c("CD4.T.cells","CD4.CD45RO.T.cells","CD4.PD1.T.cells", 
                 "CD8.effector.T.cells","CD8.CD45RO.T.cells","CD8.PD1.T.cells","B.cells"))
...
p.vals.markers2(subset(dat, therapy_sequence=="PDS"), Profile.test="BRCAmut/met", y.val = 0.35)
